...
# better to handle big data
#F90FLAGS = -g -cpp -FR -traceback -debug -free -fp-stack-check -check all -extend_source 132 -heap-arrays 10
...
#EMEP70 = ./emchem09mod/
EMEP70 = ./emchem09het/
# emep1_soa, emep45, emep68_sorga are used for more detailed chemistry; not now included
GRID   = ./grid/
LSRC   = ./line/
MAIN   = ./main/
METE   = ./mete/
...
$(TARGET) : $(MODS_OBJ) $(UTIL_OBJ) $(SITE_OBJ) $(TIME_OBJ) $(STAT_OBJ) $(METE_OBJ) $(CONC_OBJ) $(DEPO_OBJ) $(EMEP_OBJ) $(GRID_OBJ) $(LSRC_OBJ) $(PHOT_OBJ) $(PSRC_OBJ) $(ASRC_OBJ) $(MAIN_OBJ) $(EPI_OBJ)
	$(F90) $(FFLAGS) $(MODS_OBJ) $(UTIL_OBJ) $(SITE_OBJ) $(TIME_OBJ) $(STAT_OBJ) $(METE_OBJ) $(CONC_OBJ) $(DEPO_OBJ) $(EMEP_OBJ) $(GRID_OBJ) $(LSRC_OBJ) $(PHOT_OBJ) $(PSRC_OBJ) $(ASRC_OBJ) $(MAIN_OBJ) $(EPI_OBJ) $(LIBS) -o $@
